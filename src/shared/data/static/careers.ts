...
export const staticCareers: Job[] = [
  {
    ...
    summary:
      'We are seeking a dynamic Program Officer to lead our community health initiatives focused on HIV/TB/Malaria prevention and Sexual Reproductive Health.',
    description:
      'The Program Officer will be responsible for designing, implementing, and monitoring health programs that serve vulnerable communities in Homa Bay County.',
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'The Finance & Admin Officer will oversee all financial and administrative functions of WIRIA CBO.',
    responsibilities: [
