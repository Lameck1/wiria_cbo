...
export const staticOpportunities: Opportunity[] = [
    {
        ...
        description: 'This internship provides an opportunity for public health students to apply classroom knowledge in real community settings.',
        responsibilities: [
    ...
    },
    {
        ...
        description: 'Manage WIRIA social media presence, create engaging content, and document our programs.',
        responsibilities: [
        ...
        benefits: ['Portfolio building opportunity', 'Remote flexibility', 'Certificate of participation'],
        status: 'ACTIVE',
        createdAt: '2024-11-01T00:00:00Z',
        updatedAt: '2024-11-01T00:00:00Z',
    },
