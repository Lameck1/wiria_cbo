/**
 * Focus Areas Section - Enhanced with Animations
    ...
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4 lg:px-6">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-bold text-wiria-blue-dark mb-4">Our Focus Areas</h2>
                    <motion.div
                        initial={{ width: 0 }}
                        whileInView={{ width: '6rem' }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.8, delay: 0.2 }}
                        className="h-1 bg-gradient-to-r from-wiria-yellow to-wiria-green-light mx-auto rounded-full"
                    />
                </motion.div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {FOCUS_AREAS.map((area: FocusArea, index: number) => (
                        ...
                        >
                            <Link
                                to={area.link}
                                className="group block bg-white rounded-2xl p-8 text-center border border-gray-100 shadow-sm hover:shadow-xl hover:border-wiria-blue-dark/20 transition-all duration-300 hover:-translate-y-2"
                            >
                                {/* Icon Circle with hover effect */}
                                <div className="relative mx-auto mb-6 w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center group-hover:from-wiria-yellow/20 group-hover:to-wiria-green-light/20 transition-all duration-300 group-hover:scale-110">
                                    {/* Wellness Icon */}
                                    {area.title === 'Wellness' && (
                                        <svg className="w-12 h-12 text-wiria-blue-dark group-hover:text-green-600 transition-colors" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                    ...
                                    {/* Rights Icon */}
                                    {area.title === 'Rights' && (
                                        <svg className="w-12 h-12 text-wiria-blue-dark group-hover:text-blue-600 transition-colors" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                    ...
                                    {area.title === 'Impact Advocacy' && (
                                        <svg className="w-12 h-12 text-wiria-blue-dark group-hover:text-wiria-yellow transition-colors" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                            <g>
                                ...
                                <h3 className="text-xl font-bold text-wiria-blue-dark mb-3 group-hover:text-wiria-yellow transition-colors">{area.title}</h3>
                                <p className="text-gray-600 leading-relaxed text-sm">{area.description}</p>

                                {/* Learn more indicator */}
                                <div className="mt-4 flex items-center justify-center gap-1 text-wiria-blue-dark/60 group-hover:text-wiria-yellow transition-colors">
