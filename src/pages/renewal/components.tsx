    ...
    <div className="mx-auto max-w-2xl py-12">
      <Card className="border-none bg-gradient-to-b from-white to-blue-50/30 p-12 text-center shadow-2xl">
        <CardBody>
          ...
          <Button size="lg" className="h-14 px-12 text-lg shadow-lg" onClick={handleNavigate}>
            Return to Dashboard
          </Button>
        </CardBody>
      </Card>
      ...
      <Card className="border-blue-100 bg-blue-50/30">
        <CardBody>
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
              <h3 className="mb-1 text-lg font-bold text-blue-900">Group Member Count</h3>
            ...
            <div className="flex items-center gap-4">
              <div className="flex flex-col items-end text-right">
                <span className="text-xs font-bold uppercase text-gray-500">Last Recorded</span>
                <span className="font-mono text-xl font-bold text-gray-800">{maxCount}</span>
              </div>
              ...
              <div className="flex items-center justify-between border-b border-dashed border-gray-200 py-2">
                <div className="text-gray-600">
                  ...
                  <p className="text-xs text-gray-500">
                    ...
                    {feeBreakdown.newRegistration.count === 1 ? 'member' : 'members'} × KES{' '}
                    {feeBreakdown.newRegistration.rate.toLocaleString()}
                  </p>
                </div>
    ...
    >
      <Card className="mx-auto max-w-md border-none p-12 shadow-2xl">
        <CardBody>
          ...
          <Button variant="outline" fullWidth size="lg" onClick={onRefresh} disabled={isSubmitting}>
            Refresh Status
          </Button>
        </CardBody>
      </Card>
          ...
          <div className="flex items-center justify-between">
            ...
            <dd
              className={`font-mono font-bold ${
                daysUntilExpiry != null && daysUntilExpiry <= 30 ? 'text-red-500' : 'text-green-600'
              }`}
            >
              {daysUntilExpiry ?? '--'}
            </dd>
