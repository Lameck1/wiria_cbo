...
function CollapsibleSection({
    ...
    return (
        <div className="lg:contents">
            {/* Mobile: Collapsible */}
            <div className="lg:hidden bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                <button
    ...
    return (
        <Layout>
            <main>
                ...
                <section className="relative bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 py-24 overflow-hidden">
                    {/* Background Pattern */}
                    ...
                    <div className="container mx-auto px-4 lg:px-6 relative z-10">
                        ...
                        >
                            <motion.span
                                ...
                                className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 text-white rounded-full text-sm font-medium mb-6 backdrop-blur-sm border border-white/20"
                            >
                ...
                <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
                    <div className="container mx-auto px-4 lg:px-6">
                        ...
                        >
                            ...
                            >
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100/50 relative overflow-hidden">
                                    {/* Decorative gradient blob */}
                                    <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-slate-200/30 to-blue-200/30 rounded-full blur-3xl pointer-events-none" />

                                    <motion.h2
                                        initial={{ opacity: 0, y: -10 }}
                                        whileInView={{ opacity: 1, y: 0 }}
                                        viewport={{ once: true }}
                                        className="text-2xl md:text-3xl font-bold text-wiria-blue-dark mb-2 relative"
                                    >
                                        Submit a Report
                                    </motion.h2>
                                    <motion.div
                                        ...
                                        className="w-20 h-1 bg-gradient-to-r from-slate-600 to-slate-400 rounded-full mb-6 origin-left"
                                    />
