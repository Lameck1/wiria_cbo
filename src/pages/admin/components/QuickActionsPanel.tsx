...
const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    hoverColor: 'hover:bg-wiria-blue-dark',
  },
  {
    label: 'Manage Tenders',
    icon: '📜',
    route: ROUTES.ADMIN_TENDERS,
    hoverColor: 'hover:bg-wiria-yellow',
  },
  {
    label: 'Review Applications',
    icon: '💼',
    route: `${ROUTES.ADMIN_HR}?tab=applications`,
  ...
  },
  {
    ...
    icon: '📅',
    route: ROUTES.ADMIN_MEETINGS,
    hoverColor: 'hover:bg-purple-500',
  },
  {
    label: 'Manage Opportunities',
    icon: '🤝',
    route: `${ROUTES.ADMIN_HR}?tab=opportunities`,
