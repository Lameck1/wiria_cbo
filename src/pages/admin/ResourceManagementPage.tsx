              ...
              {resources.map((resource) => (
                <tr key={resource.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <span className="rounded bg-blue-50 px-2 py-1 text-xs uppercase text-blue-700">
                      {resource.category}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`rounded-full px-2 py-1 text-xs font-bold ${resource.isPublic ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}
                    >
                  ...
                  <td className="px-6 py-4 text-right">
                    <button
                      ...
                      className="mr-3 text-sm font-bold text-wiria-blue-dark hover:underline"
                    >
                      Edit
                    </button>
                    <button
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="mb-1 block text-sm font-bold">Key Points (comma separated)</label>
          <input
