...
export default function MemberManagementPage() {
  ...
  return (
    <div>
      ...
      <MemberFilters currentFilter={filter} onFilterChange={setFilter} onSearch={setSearch} />

      <MemberTable members={members} isLoading={isLoading} onViewDetails={setSelectedMember} />
