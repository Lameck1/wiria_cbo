    ...
    <div className="space-y-6">
      ...
      <div className="rounded-r-lg border-l-4 border-blue-500 bg-blue-50 p-4">
        <p className="text-sm text-gray-700">
          <strong>ℹ️ Note:</strong> Fill out the form below to apply for <strong>{jobTitle}</strong>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Provide links to your documents (Google Drive, Dropbox, etc.). Make sure links are
          publicly accessible.
        </p>
