...
export const WHY_JOIN_REASONS = [
  {
    ...
    description:
      'Continuous learning opportunities, skills development, and career advancement in the NGO sector.',
  },
  {
    icon: 'users',
    title: 'Meaningful Impact',
    description:
      "Work directly with communities and see the tangible results of your efforts in people's lives.",
  },
  {
    icon: 'smile',
    title: 'Supportive Culture',
    description:
      'Join a collaborative team that values diversity, innovation, and work-life balance.',
  },
] as const;
