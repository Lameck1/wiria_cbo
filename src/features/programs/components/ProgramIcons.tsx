/**
 * Program Icons Component
 * SVG icons for each program pillar
 */

interface ProgramIconProps {
    type: 'health' | 'rights' | 'economy' | 'climate' | 'youth';
    className?: string;
}

export function ProgramIcon({ type, className = 'w-6 h-6' }: ProgramIconProps) {
    const icons = {
        health: (
        ...
        youth: (
            <svg className={className} viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
