...
export const APPLICATION_TIPS: ApplicationTip[] = [
  {
    ...
    description:
      'Customize your CV and cover letter to highlight relevant skills and experiences for each position.',
  },
  {
    title: 'Show Your Passion',
    description:
      "Explain why you're interested in our mission and how you can contribute to community development.",
  },
  {
    title: 'Include References',
    description:
      'Provide at least two professional or academic references who can speak to your abilities.',
  },
  {
    title: 'Apply Early',
    description:
      "Don't wait until the deadline. We review applications on a rolling basis and may fill positions early.",
  },
];
