/**
 * VolunteerInternshipSection Component ()
...
function InfoCard({
  ...
  return (
    <motion.div
      ...
      className="flex h-full flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg transition-shadow hover:shadow-xl"
    >
      ...
      <div className="flex flex-grow flex-col p-6">
        ...
        <button
          onClick={ctaAction}
          className="flex w-full items-center justify-center gap-2 rounded-full bg-wiria-blue-dark px-6 py-3 font-semibold text-white transition-all hover:bg-wiria-yellow hover:text-wiria-blue-dark hover:shadow-md"
        >
          {ctaText}
...
export function VolunteerInternshipSection({
  onScrollToOpenings,
}: VolunteerInternshipSectionProps) {
