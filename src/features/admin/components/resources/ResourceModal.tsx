...
import { createResource, updateResource, uploadFile } from '@/features/admin/api/resources.api';
...
function buildResourceFields(options: {
...
export function ResourceModal({ resource, onClose, onSuccess }: ResourceModalProps) {
