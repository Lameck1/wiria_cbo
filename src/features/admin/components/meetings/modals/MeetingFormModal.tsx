...
function MeetingScheduleFields({ meeting }: { meeting: Meeting | null }) {
  return (
    <>
...
function MeetingFormFields({ meeting, isVirtual, setIsVirtual }: MeetingFormFieldsProps) {
  return (
    <>
      <div>
      ...
      <MeetingScheduleFields meeting={meeting} />
      <div className="grid grid-cols-2 gap-4">
        <div>
  ...
  return (
    ...
    >
      <form onSubmit={(event) => void handleSubmit(event)} className="space-y-4">
        <MeetingFormFields meeting={meeting} isVirtual={isVirtual} setIsVirtual={setIsVirtual} />
