      ...
      <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-5">
        {suggestedAmounts.map((amount) => (
          <motion.button
            ...
            className={`relative flex min-h-[100px] cursor-pointer flex-col items-center justify-center rounded-2xl border-2 p-2 px-3 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-wiria-yellow/50 ${
