...
const TenderInfoGrid = ({ tender, deadlineDate }: TenderInfoGridProps) => (
...
const TenderSubmissionInfo = ({ tender }: { tender: Tender }) => (
...
const TenderFooter = ({ hasDocument, onDownload, onClose }: TenderFooterProps) => (
