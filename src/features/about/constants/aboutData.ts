...
export const CORE_VALUES: Omit<CoreValue, 'icon'>[] = [
    {
        ...
        description: 'We reach those furthest behind first, ensuring equal access and opportunity for all vulnerable populations.',
        iconBg: 'bg-purple-100',
        iconColor: 'text-purple-600',
    },
    {
        title: 'Transparency & Accountability',
        description: 'Every resource entrusted to us matters. We maintain the highest standards of transparency in all our operations.',
        iconBg: 'bg-blue-100',
        iconColor: 'text-blue-600',
    },
    {
        title: 'Empowerment & Participation',
        description: 'Communities lead their own transformation. We believe in empowering people, not creating dependency.',
        iconBg: 'bg-green-100',
        iconColor: 'text-green-600',
    },
    {
        title: 'Human Rights & Dignity',
        description: 'Every life has equal worth. We defend the fundamental rights and dignity of all people.',
        iconBg: 'bg-wiria-yellow/20',
        iconColor: 'text-wiria-yellow',
    },
    {
        title: 'Evidence-Informed Action',
        description: 'Our solutions are grounded in data and lived experience, ensuring real impact for real people.',
