    ...
    <div className="mb-12">
      ...
      >
        ...
        <p>
          ...
          exploitation, and persistent violations of their fundamental rights (Government of Kenya,
          2023).
        </p>
        <motion.div
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <p className="mb-3 text-lg font-bold text-red-700">Critical Regional Challenges</p>
...
function TurningPointQuoteSection() {
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
    ...
    <div className="mb-12">
      ...
      >
        <p>
          ...
          generations of neglect. Inspired by grassroots advocacy training, local Community Health
